...
const Signup = () => {
  return (
    <>
      <div className="  w-screen flex md:flex-row flex-col  md:justify-center h-screen space-y-4">
        ...
        <div className="md:w-1/2  w-screen flex flex-col  md:justify-center h-screen px-10 space-y-4">
